...
module.exports = function(grunt) {
    ...
    grunt.registerTask('generateCss',['less','csslint','autoprefixer','csscomb','cssmin']);
    grunt.registerTask('publishCss',['generateCss','copy:publishCss']);
    grunt.registerTask('generateJS',['checkJS','concat','uglify','copy:js']);
    grunt.registerTask('publishJS',['generateJS','copy:publishJS']);
